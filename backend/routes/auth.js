...
router.post('/signup', async (req, res) => {
    try {
        ...
        const newUser = {
            ...
            profileImage: null, // ✨ 프로필 이미지 필드 초기화
        ...
        const tokenPayload = { 
            ...
            email: newUser.email,
            profileImage: newUser.profileImage // ✨ 토큰에 프로필 이미지 정보 추가
        };
...
router.post('/login', async (req, res) => {
    try {
        ...
        console.log('로그인 성공:', user.username, isAdmin(user) ? '(관리자)' : '(일반 사용자)');
