...
function Club() {
    ...
    const clubs = [
        ...
        { id: 2, name: 'CreRobot', popupImage: '/CreRobot.jpg', description: '저희 크레로봇은 로보티즈 사의 다이나믹셀 및 여러가지 제어기를 활용하여 \n 창작로봇 및 휴머로이드를 직접 제작해볼수 있는 동아리입니다.\n 이 외에도 자신이 만든 창작 로봇을 가지고 로보플러스 직업박람회등 \n다양한 대회도 참여하여 자신의 커리어를 쌓아 나갈수있습니다' },
